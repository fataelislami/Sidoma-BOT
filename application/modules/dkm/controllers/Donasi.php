...
class Donasi extends MY_Controller
{
    ...
    public function index()
    {
      ...
      $data = array(
        'contain_view' => 'dkm/donasi/donasi_list',
        'sidebar'=>'dkm/sidebar',
    ...
    public function create(){
      $data = array(
        'contain_view' => 'dkm/donasi/donasi_form',
        ...
        'action'=>'dkm/donasi/create_action'
       );
      $this->template->load($data);
    }
    ...
    public function edit($id){
      ...
      $data = array(
        'contain_view' => 'dkm/donasi/donasi_edit',
        'sidebar'=>'dkm/sidebar',//Ini buat menu yang ditampilkan di module admin {DIKIRIM KE TEMPLATE}
        'css'=>'dkm/crudassets/css',//Ini buat kirim css dari page nya  {DIKIRIM KE TEMPLATE}
        'script'=>'dkm/crudassets/script',//ini buat javascript apa aja yang di load di page {DIKIRIM KE TEMPLATE}
        'action'=>'dkm/donasi/update_action',
        'dataedit'=>$dataedit
       );
      $this->template->load($data);
    }
