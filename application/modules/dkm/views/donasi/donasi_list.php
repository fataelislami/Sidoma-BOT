            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                      <?php echo anchor(site_url($module.'/donasi/create'), '+ Tambah Data', 'class="btn btn-primary"'); ?>
      	    </div>
              </div>
                ...
                <div class="table-responsive m-t-40">
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php foreach ($datadonasi as $d): ?>
                            <tr>
                              <?php foreach ($datafield as $df): ?>
                                <td><?php echo $d->$df ?></td>
                              <?php endforeach; ?>
                                <td>
                                <a href="<?php echo base_url().$module?>/donasi/edit/<?php echo $d->id_donasi ?>">
                                        <button class="btn btn-success waves-effect waves-light m-r-10">Edit</button>
                                    </a>
                                    <a href="<?php echo base_url().$module?>/donasi/delete/<?php echo $d->id_donasi ?>">
